...
def test_phones_on_view_page(app):
    ...
    assert contact_from_home_page.home == contact_from_view_page.home
    assert contact_from_home_page.mobile == contact_from_view_page.mobile
    assert contact_from_home_page.work == contact_from_view_page.work
    assert contact_from_home_page.phone2 == contact_from_view_page.phone2
"""