...
def test_check_contact_phones(app):
    ...
    assert contacts[index].address == app.merge_text_like_on_home_page(contact_from_edit_page.address)
    assert contacts[index].firstname == app.merge_text_like_on_home_page(contact_from_edit_page.firstname)
    assert contacts[index].lastname == app.merge_text_like_on_home_page(contact_from_edit_page.lastname)
